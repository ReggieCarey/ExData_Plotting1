...
par(mfrow=c(2,2))
# Plot #1
plot(dmy(d$Date)+hms(d$Time), d$Global_active_power, type="n", xlab="",ylab="Global Active Power")
lines(dmy(d$Date)+hms(d$Time), d$Global_active_power, type="l")
# Plot #2
plot(dmy(d$Date)+hms(d$Time), d$Voltage, type="n", xlab="datetime",ylab="Voltage")
lines(dmy(d$Date)+hms(d$Time), d$Voltage, type="l")
# Plot #3
...
# Plot #4
plot(dmy(d$Date)+hms(d$Time), d$Global_reactive_power, type="n", xlab="datetime",ylab="Global_reactive_power")
lines(dmy(d$Date)+hms(d$Time), d$Global_reactive_power, type="l")
dev.off()
